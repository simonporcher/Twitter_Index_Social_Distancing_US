...
3. Date of data collection: 2020-03-16 to 2020-05-31.
4. Geographic location of data collection: Paris, France.
5. Coverage of data: United States of America. 
6. Information about funding sources that supported the collection of the data: No funding.
7. Variables description: The variables of the dataset are described in the companion paper.
